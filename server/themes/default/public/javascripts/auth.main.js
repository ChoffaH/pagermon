angular.module('app', ['ngRoute', 'ngResource', 'ui.validate'])
// Service
.factory('Api', ['$resource',
  ...
  .controller('LoginController', ['$scope', 'Api', '$timeout', '$window', function ($scope, Api, $timeout, $window) {
    $scope.loading = false;
    $scope.loginMessage = {};
  ...
  .controller('RegisterController', ['$scope', 'Api', '$timeout', '$window', function ($scope, Api, $timeout, $window) {
  ...
  .controller('ResetController', ['$scope', 'Api', '$timeout', '$window', function ($scope, Api, $timeout, $window) {
    $scope.resetMessage = {};
  ...
  .controller('ProfileController', ['$scope', 'Api', '$timeout', function ($scope, Api, $timeout) {
    $scope.alertMessage = {};
    $scope.loading = true;
